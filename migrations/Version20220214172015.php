 ...
 */
final class Version20220214172015 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_A0559D9454BD530C ON projeto (nome)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_A0559D9454BD530C ON projeto');
