 ...
 */
final class Version20220215141108 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE projeto ADD url_img_cover VARCHAR(500) NOT NULL');
    }
