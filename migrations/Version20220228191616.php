 ...
 */
final class Version20220228191616 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO `dbsaken_tasks`.`painel` (`title`) VALUES ("Index");');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE note CHANGE title title VARCHAR(50) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE conteudo conteudo VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE img_path img_path VARCHAR(500) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
