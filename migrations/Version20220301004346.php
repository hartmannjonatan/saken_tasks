 ...
 */
final class Version20220301004346 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE note ADD color VARCHAR(20) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE note DROP color, CHANGE title title VARCHAR(50) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE conteudo conteudo VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
