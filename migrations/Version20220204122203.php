 ...
 */
final class Version20220204122203 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE funcionario ADD cod_user_id INT NOT NULL');
        $this->addSql('ALTER TABLE funcionario ADD CONSTRAINT FK_7510A3CF35D62301 FOREIGN KEY (cod_user_id) REFERENCES user (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_7510A3CF35D62301 ON funcionario (cod_user_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE funcionario DROP FOREIGN KEY FK_7510A3CF35D62301');
        $this->addSql('DROP INDEX UNIQ_7510A3CF35D62301 ON funcionario');
        $this->addSql('ALTER TABLE funcionario DROP cod_user_id, CHANGE nome nome VARCHAR(50) NOT NULL COLLATE `utf8mb4_unicode_ci`');
