 ...
 */
final class Version20220211123602 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE gerente (id INT AUTO_INCREMENT NOT NULL, cod_user_id INT NOT NULL, nome VARCHAR(50) NOT NULL, UNIQUE INDEX UNIQ_306C486D35D62301 (cod_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE gerente ADD CONSTRAINT FK_306C486D35D62301 FOREIGN KEY (cod_user_id) REFERENCES user (id)');
    }
